...
FIL file_object_A; //FILE OBJECT used for rest Test A flags
FIL file_object_B; //FILE OBJECT used for rest Test B flags
FIL file_object_boot; //FILE OBJECT used for rest Test B flags

char testA_file_name[] = "0:FlagA.txt";	///<Test TEXT File name
char testA_bin_file[] = "0:TestA.bin";	///<Test BINARY File name

char testB_file_name[] = "0:FlagB.txt";	///<Test TEXT File name
